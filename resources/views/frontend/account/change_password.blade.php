			...
			<div class="m-portlet m-portlet--full-height m-portlet--tabs  ">
				...
				<div class="tab-content">
					<div class="tab-pane active show" id="m_user_profile_tab_1">
						<form class="m-form m-form--fit m-form--label-align-right" method="POST" action="{{route('account.postChangePassword')}}" id="changePassword">
							<div class="m-portlet__body">
...
@section('scripts')
{!! JsValidator::formRequest('App\Http\Requests\Frontend\ChangePasswordRequest', '#changePassword'); !!}
@endsection