				...
				<div class="m-portlet__body">
					...
					<ul class="m-nav m-nav--hover-bg m-portlet-fit--sides">
						...
						<li class="m-nav__item">
							<a href="{{route('account.profile')}}" class="m-nav__link">
						...
						<li class="m-nav__item">
							<a href="{{route('account.change-password')}}" class="m-nav__link">
			...
			<div class="m-portlet m-portlet--full-height m-portlet--tabs  ">
				...
				<div class="tab-content">
					<div class="tab-pane active show" id="m_user_profile_tab_1">
						<form class="m-form m-form--fit m-form--label-align-right" method="post" id="editProfile" action="{{route('account.postEditProfile')}}">
							<div class="m-portlet__body">
								...
								<div class="form-group m-form__group row">
									<label class="m-checkbox m-checkbox--air m-checkbox--solid m-checkbox--state-brand col-2 col-form-label"></label>
									<div class="col-7">
										@if($udata->is_two_factor_enable=='Y')
										<input type="checkbox" checked="checked" name="is_two_factor_enable"> Two factor Authentication
										@else
										<input type="checkbox" name="is_two_factor_enable"> Two factor Authentication
										@endif
									</div>
								</div>
								...
								<div class="form-group m-form__group row">
									...
									<div class="col-7">
										<input type="text" name="countryID" hidden id="countryID" value="{{$address->country ?? ''}}">
...
<div class="modal fade" id="changeProfileImg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form class="m-login__form m-form" enctype="multipart/form-data" method="post" action="{{route('account.postUpdateProfilePic')}}">
...
{!! JsValidator::formRequest('App\Http\Requests\Frontend\EditProfileRequest', '#editProfile'); !!}
@endsection