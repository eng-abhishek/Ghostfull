...
<div class="m-subheader">
	<div class="mr-auto">
		...
		<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
			...
			<li class="m-nav__separator">-</li>
			<li class="m-nav__item">
				<a href="{{route('backend.setting.mailers.edit',$mailer->id)}}" class="m-nav__link">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="m-portlet m-portlet--tab">
				...
				<!--begin::Form-->
				<form class="m-form m-form--fit m-form--label-align-right" id="mailerSetting" method="POST" action="{{route('backend.setting.mailers.update',$mailer->id)}}">
					@csrf
					@method('PUT')
					<div class="m-portlet__body">
						...
						<div class="form-group m-form__group">
							...
							<select class="form-control" name="encryption">
								...
								<option {{($mailer->encryption=='tls') ? 'selected':''}} value="tls">TLS</option>
								<option {{($mailer->encryption=='ssl') ? 'selected':''}} value="ssl">SSL</option>
							</select>
							@error('encryption')
							<span class="m-form__help error">{{$message}}</span>
							@enderror 
