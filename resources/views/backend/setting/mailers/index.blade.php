          ...
          <div class="m-portlet__head-tools">
            <ul class="m-portlet__nav">
              <li class="m-portlet__nav-item">
                <a href="{{route('backend.setting.mailers.create')}}" class="btn btn-info m-btn m-btn--custom m-btn--icon m-btn--air">
                  <span>
                    <i class="la la-plus"></i>
                    <span>Add Mailer</span>
                  </span>
                </a>
              </li>
...
<script>
  ...
  $(function () {
    ...
    var table = $('#m_table_1').DataTable({
      ...
      ajax: "{{ route('backend.setting.mailers.index') }}",
    ...
    $(document).on( 'click', '#updateStatus', function () {
      ...
      swal({
        ...
        if (result.value) {
          ...
          $.ajax({
            url:"{{route('backend.setting.mailers.change-status')}}",
            method:'post',
    ...
    $(document).on('click','.deleteRecord',function(){
      ...
      swal({
        ...
        if (result.value) {
          ...
          var url = "{{URL('backend/setting/mailers')}}";
          var dltUrl = url+"/"+id;
