...
<script>
  ...
  $(function () {
    ...
    var table = $('#m_table_1').DataTable({
      ...
      ajax: "{{ route('backend.setting.uploads.index') }}",
      ...
      {data: 'upload_at_once', name: 'upload_at_once'},

      {data: 'password_protection', name: 'password_protection'},

      {data: 'advertisements', name: 'advertisements'},
    ...
    $(document).on( 'click', '#updateStatus', function () {
      ...
      swal({
        ...
        if (result.value) {
          ...
          $.ajax({
            url:"{{route('backend.setting.uploads.change-status')}}",
            method:'post',
