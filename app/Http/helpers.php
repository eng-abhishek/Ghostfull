...
$website_dark_logo=(!empty($dark_logo)) ? $dark_logo->value :'';
//$website_dark_logo='';
return $website_dark_logo;
}

function fevicon_icon(){
$fevicon_icon=General::where('key','website_fevicon_icon')->first();
$website_fevicon_icon=(!empty($fevicon_icon)) ? $fevicon_icon->value :'';
//$website_fevicon_icon='';
return $website_fevicon_icon;
}

function app_name(){
$app_name=General::where('key','website_name')->first();
$website_app_name=(!empty($app_name)) ? $app_name->value :'Laravel';
//$website_app_name='';
return $website_app_name;
}
